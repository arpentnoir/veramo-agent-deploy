...
// @public
export function getUniversalResolver(url?: string): DIDResolver;

// @public
export function getUniversalResolverFor(methods: string[], url?: string): Record<string, DIDResolver>;

// Warning: (ae-internal-missing-underscore) The name "UniversalResolver" should be prefixed with an underscore because the declaration is marked as @internal
//

## API Report File for "@veramo/did-provider-jwk"
...
//
// src/types/jwk-provider-types.ts:9:3 - (ae-forgotten-export) The symbol "ImportOrGenerateKeyOpts" needs to be exported by the entry point index.d.ts

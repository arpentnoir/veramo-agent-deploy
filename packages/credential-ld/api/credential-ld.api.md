...
export class VeramoEcdsaSecp256k1RecoverySignature2020 extends VeramoLdSignature {
    ...
    // (undocumented)
    preDidResolutionModification(didUrl: string, didDoc: DIDDocument_2): void;
    // (undocumented)
...
//
// src/action-handler.ts:52:26 - (ae-incompatible-release-tags) The symbol "contextMaps" is marked as @public, but its signature references "ContextDoc" which is marked as @beta
// src/action-handler.ts:52:76 - (ae-incompatible-release-tags) The symbol "suites" is marked as @public, but its signature references "VeramoLdSignature" which is marked as @alpha
